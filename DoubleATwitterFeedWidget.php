...
class DoubleATwitterFeedWidget extends WP_Widget
{
	...
	function widget( $args, $instance ) {
		...
		//Styles
		$html.="<style>.tweet-text-colour{ color:".$configuration["styles"]["tweet_text_colour"].";} .tweet-background-colour{ background-color:".$configuration["styles"]["tweet_background_colour"].";} .tweet-link-colour{ color: ".$configuration["styles"]["tweet_link_colour"].";} .tweet-hashtag-colour{ color: ".$configuration["styles"]["tweet_hashtag_colour"].";}</style>";
